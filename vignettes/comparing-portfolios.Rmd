...
* Need fundamentals to screen stocks before analyzing their prices? Learn how to extract financials in the documentation for the `Ticker` class.
* For very large lists of stocks, consider using the `validate()` helper to clean up your symbols vector prior to making bulk API calls:
